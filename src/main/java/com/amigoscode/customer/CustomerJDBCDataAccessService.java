...
public class CustomerJDBCDataAccessService implements CustomerDao{
    ...
    public void insertCustomer(Customer customer) {
        ...
        System.out.println("jdbcTempalte.update = "+ result);
    }
...
//                WHERE id = ?;
//                """;
//        if(existsPersonWithId(customer.getId())) {
